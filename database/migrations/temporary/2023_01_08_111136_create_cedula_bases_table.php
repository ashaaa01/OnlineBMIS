...
class CreateCedulaBasesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cedula_bases', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('name')->nullable();
            $table->string('amount')->nullable();
            $table->string('taxable_amount')->nullable();
            $table->string('community_due')->nullable();
    ...
    {
        Schema::dropIfExists('cedula_bases');
    }
}
