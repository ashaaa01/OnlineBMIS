...
class CreateBarangayClearanceCertificatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('barangay_clearance_certificates');
    }
}
