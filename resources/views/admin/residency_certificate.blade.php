...
@section('content_page')
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                            ...
                            <li class="breadcrumb-item active">Residency Certificate Management</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" style="background: linear-gradient(to right, #1BCFB4, #A2EAD5);">
                                <h3 class="card-title" style="margin-top: 6px;"><strong>Residency Certificate Management</strong></h3>
                            </div>
                            <div class="card-body">
                                <div class="text-right mt-4">                   
                                    <button type="button" id="buttonAddModalResidencyCertificate" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAddResidencyCertificate"><i class="fa fa-plus fa-md"></i> New Residency Certificate</button>
                                </div><br>
                                <div class="table-responsive">
                                    <table id="tableResidencyCertificate" class="table table-sm table-bordered table-hover display nowrap" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>Action</th>
                                                <th>Name</th>
    ...
    <!-- Add Residency Certificate Modal Start -->
    <div class="modal fade" id="modalAddResidencyCertificate" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><i class="fas fa-info-circle"></i>&nbsp;Residency Certificate Details</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="post" id="formAddResidencyCertificate" autocomplete="off">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body">
                                    <!-- For Edit -->
                                    <input type="text" class="form-control" style="display: none" name="residency_certificate_id" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" id="buttonAddResidencyCertificate" class="btn btn-primary"><i id="iconAddResidencyCertificate" class="fa fa-check"></i> Save</button>
                    </div>
                </form>
            </div>
        </div>
    </div><!-- Add Residency Certificate Modal End -->
@endsection
...
@section('js_content')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#formAddResidencyCertificate").submit(function(event){
                event.preventDefault();
                addResidencyCertificate();
            });

            dataTablesResidencyCertificate = $("#tableResidencyCertificate").DataTable({
                "processing" : false,
                "serverSide" : true,
                "responsive": true,
                ...
                // "order": [[ 0, "desc" ],[ 4, "desc" ]],
                "ajax" : {
                    url: "view_residency_certificate",
                },
                "columns":[
            ...
            $(document).on('click', '.actionEditResidencyCertificate', function(){
                let id = $(this).attr('residency-certificate-id');
                console.log('id ', id);
                $("input[name='residency_certificate_id'", $("#formAddResidencyCertificate")).val(id);
                getResidencyCertificateById(id);
            })
            ...
            $("#buttonAddModalResidencyCertificate").on('click',function(event){
                event.preventDefault();
                getCedulaBasis();
