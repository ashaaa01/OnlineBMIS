...
@section('content_page')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Request Residency Certificate Management</h1>
                    </div>
                    <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Request Residency Certificate Management</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title" style="margin-top: 8px;">Request Residency Certificate Management</h3>
                            </div>
                            <div class="card-body">
                                <div class="text-right mt-4">                   
                                    <button type="button" id="buttonAddRequestResidencyCertificate" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAddRequestResidencyCertificate"><i class="fa fa-plus fa-md"></i> New Request Residency Certificate</button>
                                </div><br>
                                <div class="table-responsive">
                                    <table id="tableRequestResidencyCertificate" class="table table-sm table-bordered table-hover display nowrap" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Gender</th>
    ...
    <!-- Add Request Residency Certificate Modal Start -->
    <div class="modal fade" id="modalAddRequestResidencyCertificate" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><i class="fas fa-info-circle"></i>&nbsp;Request Residency Certificate Details</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="post" id="formAddRequestResidencyCertificate" autocomplete="off">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-body">
                                    <!-- For Edit -->
                                    <input type="text" class="form-control" style="display: none" name="request_residency_certificate_id" aria-label="Default" aria-describedby="inputGroup-sizing-default">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" id="buttonAddRequestResidencyCertificate" class="btn btn-primary"><i id="iconAddRequestResidencyCertificate" class="fa fa-check"></i> Save</button>
                    </div>
                </form>
            </div>
        </div>
    </div><!-- Add Request Residency Certificate Modal End -->
@endsection
...
@section('js_content')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#formAddRequestResidencyCertificate").submit(function(event){
                event.preventDefault();
                addRequestResidencyCertificate();
            });

            let user_id = {{ $user_id }};
            console.log('user_id ',user_id);
            dataTablesRequestResidencyCertificate = $("#tableRequestResidencyCertificate").DataTable({
                "processing" : false,
                "serverSide" : true,
                "responsive": true,
                ...
                // "order": [[ 0, "desc" ],[ 4, "desc" ]],
                "ajax" : {
                    url: "view_request_residency_certificate",
                    data: function (param){
            ...
            $("#buttonAddRequestResidencyCertificate").on('click',function(event){
                event.preventDefault();
                getCedulaBasis();
            });
        });
