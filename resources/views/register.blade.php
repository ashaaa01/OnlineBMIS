        ...
        <div class="row mx-auto flex-wrap-reverse align-items-center mt-5">
            ...
            <div class="col-lg-6">
                <form method="post" id="formAddUser">
                    ...
                    <div class="mb-3">
                        <label for="fileAddVotersId" class="form-label">Upload Voters/Government Id</label>
                        <input type="text" class="form-control d-none" disabled id="textAddVotersId"> <!-- Only for showing fetched file -->
                        <input type="file" class="form-control" name="voters_id" id="fileAddVotersId">
                    </div>
