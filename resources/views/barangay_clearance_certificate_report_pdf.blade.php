...
<body>
    ...
    <h2 style="text-align: center;"><strong>LIST OF BARANGAY CLEARANCE CERTIFICATES</strong><br>
    <table style="width:100%">
        <tr>
            ...
            <th style="text-transform: uppercase; white-space: normal; width: 120px; border: 1px solid black;">Amount Collection</th>
        ...
        @foreach ($data as $row)
            <tr>
                ...
                <td style="white-space: normal; border: 1px solid black;">{{ $row->amount_collection }}</td>
