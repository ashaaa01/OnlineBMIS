    ...
    <table>
        <tr>
            ...
            <td class="right-column">
                ...
                <p style="margin-left: 80px; line-height: 1.5; margin-right: 40px;">This is to certify that <span style="text-transform: capitalize"><u>{{ $name }}</u></span>, of legal age, Filipino citizen, whose specimen signature appears below, is a <strong>PERMANENT RESIDENT</strong> of this Barangay Pag-asa, Bansud, Oriental Mindoro.</p>
                <p style="text-align: justify; margin-left: 80px; line-height: 1.5; margin-right: 40px;">Based on records of this office, he/she has been residing at <span style="text-transform: capitalize"><u>{{ $address }}</u></span>,Barangay Pag-asa, Bansud, Oriental Mindoro since ____</p>
                <p style="text-align: justify; margin-left: 80px; line-height: 1.5; margin-right: 40px;">Issued this <u>{{ $day }}th</u> day of <u>{{ $month }}</u>, <u>{{ $year }}</u> here at Barangay Pag-asa, Bansud, Oriental Mindoro.</p>
                <br>
                <p style="margin-left: 7%; margin-top: 10px; line-height: 1.5;">Specimen signature:</p><br>
                <hr style="margin-left: 80px; width: 139px; border: none; border-bottom: 1px solid">
                <br>
                <br>
